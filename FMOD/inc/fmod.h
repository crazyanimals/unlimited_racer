...
#define FMOD_VERSION    0x00040203
...
typedef enum
{
    ...
    FMOD_ERR_NEEDHARDWARE,          /* Tried to use a feature that requires hardware support.  (ie trying to play a VAG compressed sound in software on PS2). */
